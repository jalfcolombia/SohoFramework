...
class usuarioBaseTableClass extends tableBaseClass {
  ...
  const __SEQUENCE = 'usuario_id_seq';
  ...
  public function save($object = null, $package = null) {
    return parent::save($this, self::$package);
  }

  public function updateRegister($object = null, $package = null) {
    return parent::updateRegister($object, $package);
  }
