...
namespace mvc\validator {
  ...
  class createUserValidatorClass extends validatorClass {
    ...
    public static function validateInsert() {
      ...
      } else if(strlen(request::getInstance()->getPost('inputUser')) > \usuarioTableClass::USER_NAME_LENGTH) {
        $flag = true;
        session::getInstance()->setFlash('inputUser', true);
        session::getInstance()->setError('El usuario digitado es mayor en cantidad de caracteres a lo permitido', 'inputUser');
      } else if(self::isUnique(\usuarioTableClass::ID, true, array(\usuarioTableClass::USER_NAME => request::getInstance()->getPost('inputUser')), \usuarioTableClass::getNameTable())) {
        $flag = true;
        session::getInstance()->setFlash('inputUser', true);
